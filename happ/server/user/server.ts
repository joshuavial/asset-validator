...
//App ID = 8f4c17b8-ec77-4cf2-9b1d-78e2832141de
app.post('/token-proof', async (req, res) => {
  const { nonce, webhook, policy, back_url, metadata } = req.body;
  try {
...
const TOKENPROOF_API_KEY = 'YOUR_API_KEY'; // Replace with your actual API key
const TOKENPROOF_APP_ID = 'YOUR_APP_ID'; // Replace with your actual app ID
